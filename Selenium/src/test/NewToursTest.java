...
public void ToursTest()
{
	...
	// example of relative xpath with contains expression
	driver.findElement(By.xpath(".//input[contains(@name,'user')]")).sendKeys("Tomg");
	
	//example of relative xpath 
	
	driver.findElement(By.xpath(".//input[@name='userName']")).sendKeys("Tomg");
	...
	//example of css selector in the contact link
	
	driver.findElement(By.linkText("CONTACT")).click();
	
	//driver.findElement(By.cssSelector("html body div table tbody tr td table tbody tr td table tbody tr td table tbody tr td a img")).cl
	
	//exmple of absolute xpath
